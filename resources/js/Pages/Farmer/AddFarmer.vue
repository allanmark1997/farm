                    ...
                    <div class="m-2 mt-2">
                        ...
                        <div class="relative overflow-x-auto mr-2 w-full">
                            ...
                            >
                                ...
                                >
                                    <thead
                                        class="text-xs text-gray-700 uppercase bg-green-100"
                                    >
                                        <tr>
                                            ...
                                            <th scope="col" class="px-6 py-3">
                                                Organic Practitioner (Yes/NO)
                                            </th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <template v-for="(i, index) in [1, 2]">
                                                ...
                                                <td class="px-6 py-4 w-full">
                                                    ...
                                                    <div class="mt-2">
                                                        ...
                                                        <input
                                                            ...
                                                            id="number_of_parcels"
                                                            class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5"
                                                            placeholder="Total Farm area (ha)"
                                                            required=""
                                                        />
                                                    </div>
                                                    <div class="mt-2">
                                                        <label
                                                            for="Ownership Document No"
                                                            class="block mb-2 text-sm font-medium text-gray-900"
                                                        >
                                                            Ownership Document
                                                            No</label
                                                        ...
                                                        <input
                                                            ...
                                                            id="number_of_parcels"
                                                            class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5"
                                                            placeholder="Ownership Document No"
                                                            required=""
                                                        />
                                                    </div>
                                                    <div class="mt-2">
