...
class FarmerController extends Controller
{
    ...
    { 
        $request->validate([
            ...
            'details.mname' => ['required', 'max:255'],
            ...
            'details.streetBirth' => ['required'],
            'details.lotBirth' => ['required'],
            ...
            'details.streetAddress' => ['required'],
            'details.lotAddress' => ['required'],
            'details.status' => ['required'],
            'details.religion' => ['required'],
